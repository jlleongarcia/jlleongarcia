...
function AuthorSnippet_AuthorSnippet(){var _avatar$childImageSha;const{author,avatar,bio}=(0,useSiteMetadata/* useSiteMetadata */.$)();return/*#__PURE__*/index_js_default().createElement("div",{className:AuthorSnippet},avatar!==null&&avatar!==void 0&&(_avatar$childImageSha=avatar.childImageSharp)!==null&&_avatar$childImageSha!==void 0&&_avatar$childImageSha.gatsbyImageData?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:avatar.childImageSharp.gatsbyImageData,alt:author,className:Avatar}):null,/*#__PURE__*/index_js_default().createElement("div",{className:Description},/*#__PURE__*/index_js_default().createElement("span",{className:WrittenBy},"Written By ",/*#__PURE__*/index_js_default().createElement("u",null,author)),/*#__PURE__*/index_js_default().createElement("p",{className:Bio},bio)));}
...
__webpack_require__(571);function ArticleTemplate(props){var _pluralize,_pluralize2;const article=props.pageContext.article;return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Seo/* Seo */.p,{title:article.title,description:article.description||undefined,useTitleTemplate:true}),/*#__PURE__*/index_js_default().createElement(Page/* Page */.T,null,/*#__PURE__*/index_js_default().createElement("article",{className:Article},/*#__PURE__*/index_js_default().createElement("div",{className:Breadcrumb},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:props.pageContext.listingPagePath,title:`Back To All ${(_pluralize=(0,pluralize/* pluralize */._)(props.pageContext.entityName))!==null&&_pluralize!==void 0?_pluralize:'Articles'}`},/*#__PURE__*/index_js_default().createElement("span",{className:BackArrow},"\u276E"),"All ",(_pluralize2=(0,pluralize/* pluralize */._)(props.pageContext.entityName))!==null&&_pluralize2!==void 0?_pluralize2:'Articles')),/*#__PURE__*/index_js_default().createElement("section",{className:Header},/*#__PURE__*/index_js_default().createElement("span",{className:Category},article.categories.join(' / ')),/*#__PURE__*/index_js_default().createElement("h1",null,article.title),/*#__PURE__*/index_js_default().createElement("div",{className:Details},article.date,/*#__PURE__*/index_js_default().createElement("span",{className:ReadingTime},article.readingTime.text))),article.banner&&article.banner.src&&/*#__PURE__*/index_js_default().createElement("section",{className:Banner},/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:article.banner.src.childImageSharp.gatsbyImageData,alt:article.banner.alt||`Image for ${article.title}`,imgClassName:BannerImage}),article.banner.caption&&/*#__PURE__*/index_js_default().createElement("span",{className:BannerCaption,dangerouslySetInnerHTML:{__html:article.banner.caption}})),/*#__PURE__*/index_js_default().createElement("section",{className:Body},/*#__PURE__*/index_js_default().createElement("div",{className:Content,dangerouslySetInnerHTML:{__html:article.body}}),article.keywords&&article.keywords.map((keyword,key)=>{return/*#__PURE__*/index_js_default().createElement("span",{key:key,className:Keyword},keyword);})),/*#__PURE__*/index_js_default().createElement("section",{className:Footer},/*#__PURE__*/index_js_default().createElement(AuthorSnippet_AuthorSnippet,null)))));}
